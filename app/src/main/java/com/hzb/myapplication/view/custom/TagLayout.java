...
/**
 * FileName: TeacherLevelLayout
 * Author: houzhengbang
 * Date: 2020-05-28 16:09
 * Description: 标签  #: aa  aa  aa  aa
 */
...
//                tv.setBackgroundResource(R.drawable.recommendteachers_bg);
                /*
...
//                tv.setTextColor(Color.WHITE);
                tv.setTextColor(Color.parseColor("#FDAF64"));
                tv.setTextSize(11);
...
//                lp.height = MarginLayoutParams.WRAP_CONTENT;
                tv.setLayoutParams(lp);
//                tv.setBackgroundResource(R.drawable.bg_radius_8_stroke);
                /*
                 * setPadding一定要在setBackgroundResource后面使用才有效！！！
                 * http://stackoverflow.com/questions/18327498/setting-padding-for-textview-not-working
                 */
