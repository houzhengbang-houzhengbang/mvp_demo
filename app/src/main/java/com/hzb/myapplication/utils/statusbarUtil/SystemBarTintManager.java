package com.hzb.myapplication.utils.statusbarUtil;
...
public class SystemBarTintManager {
    ...
    private void setupStatusBarView(Activity context, ViewGroup decorViewGroup) {
        ...
        //设置高度为Statusbar的高度
        LayoutParams params = new LayoutParams(LayoutParams.MATCH_PARENT, getStatusBarHeight(context));
