package com.hzb.myapplication.utils;
...
/**
 * FileName: RegularExpressionUtils
 * Author: houzhengbang
 * Date: 2020-05-28 16:28
 * Description: 常用正则表达式匹配工具
 */
public class RegularExpressionUtils {
    ...
    private static class LazyHolder {
        private static final RegularExpressionUtils INSTANCE = new RegularExpressionUtils();
    }

    public static final RegularExpressionUtils getInstance() {
